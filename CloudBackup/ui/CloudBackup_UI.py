...
#
# Created: Fri May 25 02:43:45 2012
...
class Ui_CloudBackupUI(object):
    def setupUi(self, CloudBackupUI):
        ...
        self.button_v_share.setGeometry(QtCore.QRect(510, 320, 93, 28))
        self.button_v_share.setObjectName(_fromUtf8("button_v_share"))
        self.lvshare = QtGui.QLabel(self.sharetab_under_vdisk)
        self.lvshare.setGeometry(QtCore.QRect(280, 330, 221, 16))
        self.lvshare.setAlignment(QtCore.Qt.AlignCenter)
        self.lvshare.setObjectName(_fromUtf8("lvshare"))
        ...
        self.button_s_share.setGeometry(QtCore.QRect(510, 320, 93, 28))
        self.button_s_share.setObjectName(_fromUtf8("button_s_share"))
        self.lsshare = QtGui.QLabel(self.sharetab_under_s3)
        self.lsshare.setGeometry(QtCore.QRect(280, 330, 221, 16))
        self.lsshare.setAlignment(QtCore.Qt.AlignCenter)
        self.lsshare.setObjectName(_fromUtf8("lsshare"))
        ...
        self.lsuserstate.setGeometry(QtCore.QRect(540, 410, 101, 20))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.button_g_share.setGeometry(QtCore.QRect(510, 320, 93, 28))
        self.button_g_share.setObjectName(_fromUtf8("button_g_share"))
        self.lgshare = QtGui.QLabel(self.sharetab_under_google)
        self.lgshare.setGeometry(QtCore.QRect(280, 330, 221, 16))
        self.lgshare.setAlignment(QtCore.Qt.AlignCenter)
        self.lgshare.setObjectName(_fromUtf8("lgshare"))
        ...
        self.lguserstate.setGeometry(QtCore.QRect(540, 410, 101, 20))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, CloudBackupUI):
        ...
        self.button_v_share.setText(QtGui.QApplication.translate("CloudBackupUI", "分享", None, QtGui.QApplication.UnicodeUTF8))
        self.lvshare.setText(QtGui.QApplication.translate("CloudBackupUI", "点击按钮用邮件分享", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.button_s_reset.setText(QtGui.QApplication.translate("CloudBackupUI", "重置", None, QtGui.QApplication.UnicodeUTF8))
        self.button_s_submit.setText(QtGui.QApplication.translate("CloudBackupUI", "提交", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.button_s_share.setText(QtGui.QApplication.translate("CloudBackupUI", "分享", None, QtGui.QApplication.UnicodeUTF8))
        self.lsshare.setText(QtGui.QApplication.translate("CloudBackupUI", "点击按钮用邮件分享", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.button_g_reset.setText(QtGui.QApplication.translate("CloudBackupUI", "重置", None, QtGui.QApplication.UnicodeUTF8))
        self.button_g_submit.setText(QtGui.QApplication.translate("CloudBackupUI", "提交", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.button_g_share.setText(QtGui.QApplication.translate("CloudBackupUI", "分享", None, QtGui.QApplication.UnicodeUTF8))
        self.lgshare.setText(QtGui.QApplication.translate("CloudBackupUI", "点击按钮用邮件分享", None, QtGui.QApplication.UnicodeUTF8))
